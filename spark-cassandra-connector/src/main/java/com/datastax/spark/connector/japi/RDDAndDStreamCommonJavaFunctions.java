...
public abstract class RDDAndDStreamCommonJavaFunctions<T> {
     ...
     *
     * @return an instance of {@link CassandraConnector}
     */
     ...
     *
     * @return an instance of {@link WriteConf}
     */
     ...
     *
     * <p>To obtain an instance of {@link RowWriterFactory} use one of utility
     * methods in {@link CassandraJavaUtil}.</p>
     *
     ...
     *
     * @return an instance of {@link WriterBuilder}
     *
     * @see CassandraJavaUtil#mapToRow(com.datastax.spark.connector.mapper.ColumnMapper)
     * @see CassandraJavaUtil#mapToRow(Class, java.util.Map)
     * @see CassandraJavaUtil#mapToRow(Class, org.apache.commons.lang3.tuple.Pair[])
     */
