...
public class CassandraJavaPairRDD<K, V> extends JavaPairRDD<K, V> {
    ...
    public CassandraJavaPairRDD<K, V> select(String... columnNames) {
        ...
        Object select = rdd().select(columnRefs);
        CassandraRDD<Tuple2<K, V>> newRDD = (CassandraRDD<Tuple2<K, V>>) select;
        return wrap(newRDD);
    }
    ...
    public CassandraJavaPairRDD<K, V> select(ColumnRef... selectionColumns) {
        ...
        CassandraRDD<Tuple2<K, V>> newRDD = (CassandraRDD<Tuple2<K, V>>) rdd().select(columnRefs);
        return wrap(newRDD);
    }
    ...
    public CassandraJavaPairRDD<K, V> withAscOrder() {
        CassandraRDD<Tuple2<K, V>> newRDD = (CassandraRDD<Tuple2<K, V>>) rdd().withAscOrder();
        return wrap(newRDD);
    }
    ...
    public CassandraJavaPairRDD<K, V> withDescOrder() {
        CassandraRDD<Tuple2<K, V>> newRDD = (CassandraRDD<Tuple2<K, V>>) rdd().withDescOrder();
        return wrap(newRDD);
    }
    ...
    public CassandraJavaPairRDD<K, V> limit(Long rowsNumber) {
        CassandraRDD<Tuple2<K, V>> newRDD = (CassandraRDD<Tuple2<K, V>>) rdd().limit(rowsNumber);
        return wrap(newRDD);
    }
